 ...
 *
 */
public class AutoTurnCommandVKeepPos extends Command {
	 ...
	 *            counterclockwise
	 */
	public AutoTurnCommandVKeepPos(double degreesNeededToTurn) {
	...
	protected boolean isFinished() {
		if ((Math.abs(degreesLeftToTurn) <= RobotMap.AUTO_TURN_TOLERANCEV2) || timer.hasPeriodPassed(1.5)) {//1 sec
			return true;
		} else {
			return false;
		}
