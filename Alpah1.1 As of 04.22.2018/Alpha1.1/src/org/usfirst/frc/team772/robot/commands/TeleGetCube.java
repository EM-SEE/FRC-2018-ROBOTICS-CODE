...
public class TeleGetCube extends CommandGroup {
    ...
    public TeleGetCube() {
    	...
    	Robot.driveRobot.cancel();// put back in by Abbie to test if this is a problem
...
//    	if (SmartDashboard.getNumber("TargetY", -1) != -1) {
    		...
    		addSequential(new AutoDriveVisionCommandVTeleGetCube());
    		addSequential(new IntakeXSecCommand(1));
    		addSequential(new ClampIntakeCommand(true));
//    	}	
    	Robot.driveRobot.start();// put back in by Abbie to test if this is a problem
