 ...
 *
 */
public class AutoTurnVisionCommandTurbo extends Command {
	 ...
	 */
	public AutoTurnVisionCommandTurbo() {
	...
	protected void execute() {
		...
		double minspeed = RobotMap.AUTO_TURN_MIN_SPEEDVTURBO;
		double minangle = 0.1;
		double maxspeed = RobotMap.AUTO_TURN_MAX_SPEEDVTURBO;
		double maxangle = 60;
		// the plan:
