...
//	double currentIntake1;
//	double currentIntake2;
...
//		currentIntake2 = pdp.getVoltage();
//	
//		
//		if (currentIntake2 < RobotMap.MaxIntakeVoltageAllowed) {
//			intake2Motor.set(0);
//			Timer.delay(0.1);
//			intake2Motor.set(speed);
//		}else {
//			intake2Motor.set(speed);
//		}
//		SmartDashboard.putString("VOLTAGE", ""+ currentIntake2);
	}
