 ...
 *
 */
public class AnalogManualElevatorCommandDown extends Command {
	 ...
	 */
	public AnalogManualElevatorCommandDown() {
	}
	...
	protected void execute() {
		Robot.elevatorSubsystem.elevatorSpeed(-Robot.m_oi.OperatorStick().getRawAxis(2));
