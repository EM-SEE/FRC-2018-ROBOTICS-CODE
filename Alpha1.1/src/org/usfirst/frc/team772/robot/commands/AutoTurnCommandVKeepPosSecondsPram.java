 ...
 *
 */
public class AutoTurnCommandVKeepPosSecondsPram extends Command {
	 ...
	 *            counterclockwise
	 */
	public AutoTurnCommandVKeepPosSecondsPram(double degreesNeededToTurn, double seconds, double min, double max) {
	...
	protected boolean isFinished() {
		if ((Math.abs(degreesLeftToTurn) <= RobotMap.AUTO_TURN_TOLERANCEV2) || timer.hasPeriodPassed(seconds)) {//1 sec
			return true;
		} else {
			return false;
		}
