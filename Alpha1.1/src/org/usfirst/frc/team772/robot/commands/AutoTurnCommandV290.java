 ...
 *
 */
public class AutoTurnCommandV290 extends Command {
	 ...
	 *            counterclockwise
	 */
	public AutoTurnCommandV290(double degreesNeededToTurn) {
...
//		Robot.driveSubsystem.resetGyro();
	...
	protected boolean isFinished() {
		if ((Math.abs(degreesLeftToTurn) <= RobotMap.AUTO_TURN_TOLERANCEV2) || timer.hasPeriodPassed(5)) {//1.45
			return true;
		} else {
			return false;
		}
	...
	protected void end() {
		SmartDashboard.putString("DB/String 5", "RotationSpeed: " + rotationSpeed);
