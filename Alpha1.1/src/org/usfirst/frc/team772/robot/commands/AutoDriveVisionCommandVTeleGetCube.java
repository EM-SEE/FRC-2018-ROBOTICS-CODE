 ...
 *
 */
public class AutoDriveVisionCommandVTeleGetCube extends Command {
	 ...
	 */
	public AutoDriveVisionCommandVTeleGetCube() {

	}

	// Called just before this Command runs the first time
	protected void initialize() {
		Robot.m_oi.DriverStick().setRumble(RumbleType.kLeftRumble, 0.45);
		Robot.m_oi.DriverStick().setRumble(RumbleType.kRightRumble, 0.45);
