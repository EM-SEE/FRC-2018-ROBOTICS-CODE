...
public class pulsedLightLIDAR { // We don't need any pid system, So I took out the code where LIDAR
    ...
    private final int LIDAR_DISTANCE_REGISTER = 0x8f;//v1//0x0f
//    private final int LIDAR_DISTANCE_REGISTER = 0x8f;//v3
...
//        i2c = new I2C(Port.kOnboard, LIDAR_ADDR);
     ...
     */
    private void update() {
        i2c.write(LIDAR_CONFIG_REGISTER, 0x04); // Initiate measurement 04
